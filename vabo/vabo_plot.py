...
def plot_gp_1d(gp, inputs, acq_feasible_points, beta=3, fmin=None, is_safe_opt=False, **kwargs):
    ...
    axis.scatter(acq_feasible_points, np.zeros_like(acq_feasible_points), marker='o', linewidth=5, alpha=0.3, color='g')
